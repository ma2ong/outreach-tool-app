...
{company}에서 검토하실 만한 범위를 간단히 정리해 드립니다.
  ...
  · 렌탈용 P2.604 / P2.976 / P3.91 / P4.8, 실내·실외용, 다이캐스팅 캐비닛
...
ALLEN_STYLE_DM = [
    ("私信 · 产品线对比（韩语）", "ko",
     ...
     "Allen입니다. 렌탈용은 실내·실외 모두 P2.604 / P2.976 / P3.91 / P4.8 제품을 공급하고 있습니다. 필요하신 피치나 사양을 알려주시면 맞는 제품으로 추천드리고 상세 견적도 보내드리겠습니다."),
]
