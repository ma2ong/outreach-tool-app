"""
Email sender v49 — USA v49 batch (6 companies with email)
San Diego CA / Austin TX / Fort Lauderdale FL / Cleveland OH / Milwaukee WI /
...
TARGETS = [
    {"no": 705, "company_en": "San Diego Video Wall",   "email": "hello@videowallsandiego.com", "name": "San Diego Video Wall Team", "city": "San Diego, CA"},
    {"no": 706, "company_en": "TSV Sound & Vision",     "email": "info@tsvatx.com",             "name": "TSV Team",                  "city": "Austin, TX"},
    {"no": 707, "company_en": "SoFlo Studio",           "email": "info@soflostudio.com",        "name": "SoFlo Studio Team",         "city": "Fort Lauderdale, FL"},
    {"no": 710, "company_en": "Ohio LED Wall",          "email": "info@ohioledwall.com",        "name": "Ohio LED Wall Team",        "city": "Cleveland, OH"},
    {"no": 711, "company_en": "All Pro Audio Visual",   "email": "info@allproaudiovisual.com",  "name": "All Pro AV Team",           "city": "Milwaukee, WI"},
    {"no": 712, "company_en": "LV Led Video Wall",      "email": "info@lvledvideowall.com",     "name": "LV Led Video Wall Team",    "city": "Las Vegas, NV"},
    {"no": 713, "company_en": "Alliance Audio Visual",  "email": "rentals@allianceav.com",      "name": "Alliance AV Team",          "city": "Albuquerque, NM"},
]
...
def main():
    if not GMAIL_APP_PASSWORD:
        ...
        print('  $env:GMAIL_APP_PASSWORD="xxxx xxxx xxxx xxxx"; python email_sender_v49.py')
        return

    print(f"=== Email Sender v49 | {len(TARGETS)} USA companies | {TODAY} ===\n", flush=True)
    sent = 0
