"""
IG DM v48 — 4 accounts (after warmup_v48)
...
TARGET_USERNAMES = [
    "rockymountainroll",
    "sealsproductions",
    "ampdlightingaudiovisual",
    "avl_solutions",
]

MESSAGES = {
    "rockymountainroll": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in Idaho and the Pacific Northwest. Your LED video wall and event production services across the Boise area look great — 40+ years in the business is impressive. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to share specs and pricing."
    ),
    "sealsproductions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event production companies in Tennessee. Your LED display and AV rental services for events in the Chattanooga area look great. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to connect."
    ),
    "ampdlightingaudiovisual": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for premium AV rental companies in the Pacific Northwest. Your large-format LED video wall setup for concerts and corporate events across Spokane looks impressive. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to share specs."
    ),
    "avl_solutions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in the Southeast US. Your outdoor mobile LED screen rental services for festivals and events in the Greenville area look great — 20+ years of experience shows. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to connect."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v48 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
