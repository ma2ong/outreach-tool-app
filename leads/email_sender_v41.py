"""
Email sender v41 — USA v41 batch (7 companies)
DC/Mid-Atlantic: Rent LED Video Walls, Media Support Services, AV Actions Inc
SF Bay Area: Stage Lights and Sound, Amos Productions, Megahertz AV
New Orleans: Corporate Lighting and Audio
"""
...
TARGETS = [
    {"no": 643, "company_en": "Rent LED Video Walls",        "email": "info@rentledvideowall.com",    "name": "Rent LED Team",          "city": "Annapolis, MD"},
    {"no": 644, "company_en": "Media Support Services Inc",  "email": "info@mssav.com",               "name": "Media Support Team",     "city": "Baltimore, MD"},
    {"no": 645, "company_en": "AV Actions Inc",              "email": "info@avactions.com",           "name": "AV Actions Team",        "city": "Alexandria, VA"},
    {"no": 646, "company_en": "Stage Lights and Sound",      "email": "Sales@StageLightsandSound.com","name": "Stage Lights Team",      "city": "Richmond, CA"},
    {"no": 647, "company_en": "Amos Productions",            "email": "info@amospro.com",             "name": "Amos Productions Team",  "city": "Livermore, CA"},
    {"no": 648, "company_en": "Megahertz AV",                "email": "info@mhzav.com",               "name": "Megahertz Team",         "city": "Santa Clara, CA"},
    {"no": 649, "company_en": "Corporate Lighting and Audio","email": "sales@corplighting.com",       "name": "Corporate Lighting Team","city": "New Orleans, LA"},
]
...
def main():
    if not GMAIL_APP_PASSWORD:
        ...
        print('  $env:GMAIL_APP_PASSWORD="xxxx xxxx xxxx xxxx"; python email_sender_v41.py')
        return

    print(f"=== Email Sender v41 | {len(TARGETS)} USA companies | {TODAY} ===\n", flush=True)
