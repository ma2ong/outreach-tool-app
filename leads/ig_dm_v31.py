"""
IG DM Sender v31 - USA batch (nos 574-579 with IG accounts)
...
MESSAGES = {
    "event_technology_services": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event rental companies in Las Vegas. "
        "Your LED sphere and LED screen rental services for events caught our attention. "
        "We supply P1.9–P3.9 indoor LED panels and modular display systems compatible with most LED processors. "
        "If you're looking to expand your screen inventory, happy to share specs and pricing."
    ),
    "ledrentalshouston": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event rental companies in Texas. "
        "Your LED screen and stage rental service in Houston looks impressive. "
        "We supply P2–P5 indoor and outdoor LED panels to event rental companies at competitive pricing. "
        "If you're looking to add inventory, happy to connect."
    ),
    "pacificcoastentertainment": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED video wall panels for event production companies in California. "
        "Your PCE LED video wall installations at Great Park Live and touring productions are impressive. "
        "We supply P1.9–P3.9 LED panels and tiles compatible with NovaStar/Brompton processors. "
        "If you're sourcing panels for upcoming builds or tours, happy to share pricing."
    ),
    "audiovideola": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in Los Angeles. "
        "Your full-service AV production in LA including LED walls caught our attention. "
        "We supply P2–P4 indoor LED panels and tiles to AV rental companies serving corporate and event clients. "
        "If you're expanding your LED inventory, happy to share specs and quotes."
    ),
    "atlspecialfx": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED video wall panels for event companies across the USA. "
        "Your LED video wall rental service alongside your special effects productions is impressive. "
        "We supply high-brightness P2–P5 indoor/outdoor LED panels (up to 5000+ nit) suitable for your event scale. "
        "If you're looking to expand your LED wall inventory, happy to discuss specs and pricing."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v31 | {len(queue)} USA accounts | {TODAY} ===\n", flush=True)
