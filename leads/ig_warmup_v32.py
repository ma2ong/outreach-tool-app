"""
IG Warmup v32 - LatAm batch (Colombia x3 + Peru x1 + Argentina x1)
Like latest post + follow for each account via CDP
"""
...
def main():
    ...
    print(f"=== IG Warmup v32 | {len(queue)} LatAm accounts | {TODAY} ===\n", flush=True)
