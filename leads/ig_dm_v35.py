"""
IG DM v35 - USA v33 batch (8 accounts, all warmed up in ig_warmup_v35.py)
...
MESSAGES = {
    "specialfxrentals": (
        ...
        "Your multi-city LED video wall rental operation across Nashville, Dallas, Chicago, NYC, and Tampa is impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing to rental companies. "
        "If you're sourcing panels or expanding inventory, happy to share specs and pricing."
    ),
    "abavrentals": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in Houston. "
        "Your LED video wall rental service for corporate events and trade shows looks great. "
    ...
    "atl_proav": (
        ...
        "Your full-service LED wall production for live and virtual events is impressive. "
        "We supply P1.9–P3.9 fine-pitch indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels or expanding inventory, happy to share specs."
    ),
    "rayne_events": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in the DC/mid-Atlantic area. "
        "Your LED video wall services across DC, Dallas, Nashville, Chicago, and Atlanta look impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to share pricing and specs."
    ),
    "promosamgmt": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED video wall panels for production companies in Seattle. "
        "Your LED video wall services for events, concerts, and film are impressive. "
        "We supply P1.9–P3.9 LED panels compatible with Brompton/NovaStar processors. "
        "If you're sourcing panels, happy to share specs and pricing."
    ),
    "coloradoliveevents": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Denver. "
        "Your LED video wall rental services for conferences and events look great. "
        "We supply P2–P5 indoor and outdoor LED panels at competitive factory pricing. "
        "If you're looking to expand your LED inventory, happy to connect."
    ),
    "centricevents": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in Phoenix. "
        "Your LED video wall rental service across 16 Arizona cities is impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels for trade shows or outdoor setups, happy to share specs."
    ),
    "vegasledrentals": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED screen panels for rental companies in Las Vegas. "
        "Your dedicated LED screen rental service for weddings, corporate events, and trade shows is impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to connect."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v35 | {len(queue)} USA v33 accounts | {TODAY} ===\n", flush=True)
