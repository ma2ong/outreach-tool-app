"""
Email sender v45 — USA v45 batch (8 companies with email)
Hurricane UT, Gahanna OH, Nashville TN, Charlton MA, Birmingham AL,
San Jose CA, Oklahoma City OK, Providence RI
"""
...
TARGETS = [
    {"no": 676, "company_en": "Final Design Group",  "email": "SWLemmon@fdgtv.com",        "name": "Final Design Team",     "city": "Hurricane, UT"},
    {"no": 677, "company_en": "The Penn Group",       "email": "sales@thepenn.group",        "name": "The Penn Team",         "city": "Gahanna, OH"},
    {"no": 678, "company_en": "Concept Pixels",       "email": "info@conceptpixels.com",     "name": "Concept Pixels Team",   "city": "Nashville, TN"},
    {"no": 679, "company_en": "Supreme AV",           "email": "Shane@supremeav.net",        "name": "Shane",                 "city": "Charlton, MA"},
    {"no": 680, "company_en": "Moon Men DJs",         "email": "info@moonmenonline.com",     "name": "Moon Men Team",         "city": "Birmingham, AL"},
    {"no": 681, "company_en": "A1 Visuals",           "email": "A1visualevents@gmail.com",   "name": "A1 Visuals Team",       "city": "San Jose, CA"},
    {"no": 682, "company_en": "Myx Productions",      "email": "info@myxproductions.com",    "name": "Myx Productions Team",  "city": "Oklahoma City, OK"},
    {"no": 685, "company_en": "Event Expert",         "email": "hello@eventexpert.io",       "name": "Event Expert Team",     "city": "Providence, RI"},
]
...
def main():
    if not GMAIL_APP_PASSWORD:
        ...
        print('  $env:GMAIL_APP_PASSWORD="xxxx xxxx xxxx xxxx"; python email_sender_v45.py')
        return

    print(f"=== Email Sender v45 | {len(TARGETS)} USA companies | {TODAY} ===\n", flush=True)
    sent = 0
