"""
IG DM Sender v30 - USA batch (nos 568-571)
...
MESSAGES = {
    "airbornevisuals": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for trade show and event rental companies. "
        "Your booth LED configurations look impressive across Las Vegas, Orlando, and Chicago. "
        "We supply modular P2.5–P4 LED tiles with custom configurations for trade show booth setups. "
        "Would love to discuss panel options — are you sourcing new LED inventory this year?"
    ),
    "audiotekhouston": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we make LED video wall panels for event production companies in the US. "
        "Your work across Houston and the Southeast looks great. "
        "We supply P2.5–P5 indoor and outdoor LED panels to AV production companies — competitive pricing, fast air freight. "
        "If you're expanding your LED wall inventory, happy to share a quote."
    ),
    "geoeventla": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED video wall panels for AV rental companies on the West Coast. "
        "Your 1000s of LED tiles inventory caught my attention. "
        "We supply P1.9–P3.9 LED panels in large quantities to production rental companies. "
        "If you're looking to expand or replace tiles, we'd love to compare specs and pricing."
    ),
    "led_video_walls": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for rental and sales companies in the US. "
        "Your Orlando and Vegas LED video wall operations are impressive. "
        "We supply P2–P4 indoor and outdoor LED panels with turnkey packages. "
        "Are you looking to add inventory for either location? Happy to share pricing."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v30 | {len(queue)} USA accounts | {TODAY} ===\n", flush=True)
