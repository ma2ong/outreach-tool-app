"""
IG DM v41 — v40 pending (2: @philly_audio_visual, @dpcevents) +
            v41 warmup-done batch (4: @insaneimpact, @avactions_dc, @amospro_av, @corplighting)
"""
...
TARGET_USERNAMES = [
    # v40 warmup-done, still pending
    "philly_audio_visual",
    "dpcevents",
    # v40 warmup pending (now included in v41 warmup)
    "insaneimpact",
    # v41 batch (run after ig_warmup_v41.py)
    "avactions_dc",
    "amospro_av",
    "corplighting",
]
...
def main():
    ...
    print(f"=== IG DM v41 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
