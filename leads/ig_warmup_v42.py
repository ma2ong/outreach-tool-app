"""
IG Warmup v42 — v42 USA batch (5 accounts)
Ultimate Outdoor Entertainment (@ultimateoutdoorentertainment) - Cerritos, CA
Mercury Sound & Lighting (@mercurysl) - Wixom, MI
C&H Audio Visual Services (@chaudiovisual) - Louisville, KY
Nova Productions LLC (@nova_productions_llc) - Omaha, NE
PRI Productions (@priproductions) - Jacksonville, FL
"""
...
def main():
    ...
    print(f"=== IG Warmup v42 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
    done = 0
