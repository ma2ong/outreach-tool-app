"""
IG Warmup v39 - USA v37 batch (5 new IG accounts)
Insane Impact (@insaneimpact) - Chicago
CMG Visuals (@cmgvisualsled) - Dallas
Boston Audio Rentals (@bostonaudiorentals) - Boston
New Image Event Productions (@nie_nyc) - NYC
A.V. Rental Services Inc (@philly_audio_visual) - Philadelphia
"""
...
def main():
    ...
    print(f"=== IG Warmup v39 | {len(queue)} USA v37 accounts | {TODAY} ===\n", flush=True)
    done = 0
    ...
    print(f"Next: wait 24h+ then run ig_dm_v40.py")
