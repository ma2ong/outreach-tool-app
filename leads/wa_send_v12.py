"""
WA sender v12 - Argentina Córdoba (no 551) + Chile (nos 552, 553, 554)
...
MSG_CL = (
    "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricante de pantallas LED en China. "
    "Trabajamos con empresas de arriendo e instalacion en Chile. "
    "¿Tienen proyectos activos o planificados? "
    "Podemos dar soporte tecnico y cotizaciones competitivas."
)

TARGET_NOS = [551, 552, 553, 554]
...
def main():
    ...
    print(f"=== WA Sender v12 | {len(contacts)} Argentina+Chile v26 | {TODAY} ===\n", flush=True)

    sent_count = 0
    for i, p in enumerate(contacts, 1):
        country = p.get("country", "Chile")
        msg = COUNTRY_MSG.get(country, MSG_CL)
