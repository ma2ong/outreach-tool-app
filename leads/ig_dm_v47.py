"""
IG DM v47 — 4 accounts (after warmup_v47)
...
MESSAGES = {
    "gsf_productions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV production companies in the Raleigh area. Your LED video wall rental and production services for corporate events and live shows in NC look great. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to share specs and pricing."
    ),
    "productiononeav": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV production companies in Memphis. Your LED video wall rental and installation services for corporate events and concerts in the Memphis area look impressive. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to connect."
    ),
    "techproavtx": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV integrators and video wall installers in Texas. Your video wall installation and digital signage work in El Paso looks great. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing panels for upcoming projects, happy to share specs."
    ),
    "voxaudiovisual": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for commercial LED wall installers in Oklahoma. Your VOX Video Walls indoor and outdoor LED wall systems look impressive. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to connect and share specs."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v47 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
