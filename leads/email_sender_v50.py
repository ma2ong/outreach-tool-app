"""
Email sender v50 — USA v50 batch (6 companies with email)
Chicopee MA / Boston MA / Lowell MA / Wilmington DE / Harrisburg PA / Tampa FL
"""
...
TARGETS = [
    {"no": 715, "company_en": "Zasco Productions",       "email": "info@zasco.com",                    "name": "Zasco Team",            "city": "Chicopee, MA"},
    {"no": 716, "company_en": "Boston Video Wall",        "email": "hello@videowallboston.com",         "name": "Boston Video Wall Team", "city": "Boston, MA"},
    {"no": 717, "company_en": "Audio East",               "email": "sales@audioeast.com",               "name": "AE Event Systems Team",  "city": "Lowell, MA"},
    {"no": 720, "company_en": "Video WallTronics",        "email": "mitch@rentbigscreens.com",          "name": "Mitch",                  "city": "Wilmington, DE"},
    {"no": 721, "company_en": "JP Lilley & Son",          "email": "john.kurtinecz@jplilley.com",       "name": "JP Lilley Team",         "city": "Harrisburg, PA"},
    {"no": 722, "company_en": "Tampa Video Wall Rental",  "email": "TampaVideoWallRental@gmail.com",    "name": "Tampa Video Wall Team",  "city": "Tampa, FL"},
]
...
def main():
    ...
    print(f"=== Email Sender v50 | {len(TARGETS)} targets | {TODAY} ===", flush=True)
