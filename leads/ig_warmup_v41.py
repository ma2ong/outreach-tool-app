"""
IG Warmup v41 — v41 USA batch (3 accounts) + @insaneimpact pending from v40
Insane Impact (@insaneimpact) - Chicago [v40 pending]
AV Actions Inc (@avactions_dc) - Alexandria, VA
Amos Productions (@amospro_av) - Livermore, CA
Corporate Lighting and Audio (@corplighting) - New Orleans, LA
"""
...
def main():
    ...
    print(f"=== IG Warmup v41 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
    done = 0
