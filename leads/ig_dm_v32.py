"""
IG DM v32 - USA retry batch (@4wall + @geoeventla)
Both failed in v29/v30 due to timing (input len=0 after type)
Fix: 1.5s pre-type sleep + retry logic (confirmed working in v31)
"""
...
MESSAGES = {
    "4wall": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for large-scale event and entertainment companies in the US. "
        "4Wall's nationwide production and touring LED deployments are impressive. "
        "We supply P1.5–P3.9 LED panels and tiles compatible with Brompton/NovaStar processors to companies at your scale. "
        "If you're sourcing panels for upcoming shows or expanding inventory, happy to share specs and pricing."
    ),
    "geoeventla": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED video wall panels for event production companies in Los Angeles. "
        "Your large-scale LED tile inventory for touring, corporate shows, and esports events on the West Coast is impressive. "
        "We supply P1.9–P3.9 LED panels in large quantities to rental companies at your scale. "
        "If you're sourcing panels or expanding your LED inventory, happy to share pricing."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v32 | {len(queue)} USA retry | {TODAY} ===\n", flush=True)
