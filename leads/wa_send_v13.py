"""
WA sender v13 - Argentina v27 (nos 555, 556, 557, 558)
Buenos Aires x2, Bahía Blanca, Mar del Plata
"""
...
def main():
    ...
    print(f"=== WA Sender v13 | {len(contacts)} Argentina v27 | {TODAY} ===\n", flush=True)
