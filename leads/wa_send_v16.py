"""
WA sender v16 — USA confirmed mobile numbers
Mitey AV (no:612) +1(504)266-5681 | The One Up Group (no:618) +1(310)666-2250
Both confirmed via Facebook page WhatsApp button
"""
...
MSG = (
    ...
    "Would love to connect if you're looking to source or expand your LED inventory."
)
...
def main():
    ...
    print(f"=== WA Sender v16 | {len(contacts)} USA | {TODAY} ===\n", flush=True)
