"""
IG Warmup v44 — v44 USA batch (8 accounts)
LightSmiths (@lightsmiths.seattle) - Seattle, WA
ERG247 (@erg247) - Tampa, FL
Control Entertainment (@control_entertainment) - San Diego, CA
Take One AV (@takeoneav) - Salt Lake City, UT
Mountain AV (@mountain_av) - Salt Lake City, UT
Great Lakes AV (@greatlakesav) - Milan, OH
NPi AV (@npiaudiovisualsolutions) - Cleveland, OH
AV Pro NC (@avproductionsnc) - Monroe, NC
"""
...
def main():
    ...
    print(f"=== IG Warmup v44 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
    done = 0
