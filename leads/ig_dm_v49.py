"""
IG DM v49 — v49 USA batch (6 accounts, after warmup)
TSV Sound & Vision (@tsvusa) - Austin, TX
SoFlo Studio (@soflostudio) - Fort Lauderdale, FL
Master Sound Productions (@mastersoundpro) - Fort Lauderdale, FL
MediaQuest (@mediaquestpgh) - Pittsburgh, PA
All Pro Audio Visual (@allproaudiovisual) - Milwaukee, WI
VEGAS Event Group (@vegaseventgroup) - San Antonio, TX
"""
...
MESSAGES = {
    "tsvusa": (
        "Hi, I'd like to share some recent LED display projects we delivered in Korea — P1.86 indoor walls, P2.5 commercial installs, P3.91 and P10 outdoor screens. Saw your LED video wall work in Austin and thought it might be relevant. If you have any upcoming projects, feel free to reach out — happy to recommend products and share competitive pricing."
    ),
    "soflostudio": (
        "Hi, I'd like to share some recent LED display projects we delivered in Korea — P1.86 fine-pitch indoor walls, P2.5 commercial installs, and P10 outdoor billboard screens. Your LED screen rental and production work across South Florida looks great. If you have any upcoming projects, feel free to contact me — happy to provide specs and pricing."
    ),
    "mastersoundpro": (
        "Hi, I'd like to share some recent LED display projects we delivered in Korea — indoor fine-pitch P1.86/P2.5 walls and outdoor P3.91/P10 screens for commercial and event use. Your LED video wall services across Miami and Broward look impressive. If you have any upcoming projects, feel free to reach out anytime."
    ),
    "mediaquestpgh": (
        "Hi, I'd like to share some recent LED display projects we delivered in Korea — P1.86 indoor LED walls, P2.5 commercial screens, and P10 outdoor billboard displays. Your high-resolution LED wall integration work in Pittsburgh looks great. If you have any upcoming projects, happy to share specs and competitive pricing."
    ),
    "allproaudiovisual": (
        "Hi, I'd like to share some recent LED display projects we delivered in Korea — P1.86 fine-pitch indoor walls, P2.5 commercial installs, and P3.91/P10 outdoor screens. Your LED video wall rental services for corporate events in Milwaukee look great. If you have any upcoming projects, feel free to contact me anytime."
    ),
    "vegaseventgroup": (
        "Hi, I'd like to share some recent LED display projects we delivered in Korea — P1.86 indoor LED walls, P2.5 commercial screens, and P3.91/P10 outdoor displays. Your award-winning LED video wall rentals in San Antonio look impressive. If you have any upcoming projects, happy to recommend suitable products and provide competitive pricing."
    ),
}

DEFAULT_MSG = (
    "Hi, I'd like to share some recent LED display projects we delivered in Korea — P1.86 fine-pitch indoor walls, P2.5 commercial installs, and P3.91/P10 outdoor screens. If you have any upcoming LED projects, feel free to reach out — happy to share specs and competitive pricing."
)
...
def main():
    ...
    print(f"=== IG DM v49 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
