"""
WA sender v6 - Mexico v20 (nos 520-524), 5 contacts.
"""
...
def main():
    ...
    print(f"=== WA Sender v6 | {len(contacts)} Mexico | {TODAY} ===\n", flush=True)
