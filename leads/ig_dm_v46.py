"""
IG DM v46 — 4 accounts (after warmup_v46)
Uses JS el.focus() + el.click() before Input.insertText to fix focus issue (v44 lesson)
Product range: P0.7-P10 (standard description per user instruction 2026-05-26)
"""
...
TARGET_USERNAMES = [
    "xperienceent",
    "phoenixledscreens",
    # limelightsentertain — excluded: lighting company (Lime Lights Entertainment)
    # mtisoundlighting — excluded: lighting company (MTI Sound "Stage And Lighting Company")
]

MESSAGES = {
    "xperienceent": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in the Phoenix area. Your LED video wall rental services for corporate events and trade shows in Greater Phoenix look great. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to share specs and pricing."
    ),
    "phoenixledscreens": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for LED screen rental companies in Phoenix. Your LED screen and video wall rental services for churches, trade shows, and corporate events across Greater Phoenix look impressive. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to connect."
    ),
    "limelightsentertain": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for entertainment companies in the Cleveland area. Your LED video wall rental services for weddings, corporate events, and trade shows in Ohio look great. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're sourcing LED panels, happy to share specs and pricing."
    ),
    "mtisoundlighting": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in Florida. Your LED wall rental and event production services in the Orlando area look impressive. We supply P0.7–P10 indoor and outdoor LED panels at factory-direct pricing. If you're looking to expand your LED inventory, happy to connect."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v46 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
