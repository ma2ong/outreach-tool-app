"""
WA sender v8 - Colombia v22 + Peru v22 mobile numbers
nos 385, 531, 532, 533, 535 (Colombia) + 536 (Peru)
Spanish message for Colombia; Spanish message for Peru
"""
...
MSG_ES = (
    ...
    "Trabajamos con integradores y empresas de alquiler en Colombia. "
    "¿Tienen proyectos activos o planificados? "
    "Podemos dar soporte técnico y cotizaciones competitivas."
)

MSG_PE = (
    "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricante de pantallas LED en China. "
    "Trabajamos con empresas de alquiler y producción audiovisual en Perú. "
    "¿Tienen proyectos activos o planificados? "
    "Podemos dar soporte técnico y cotizaciones competitivas."
)

TARGET_NOS = [385, 531, 532, 533, 535, 536]
...
def main():
    ...
    print(f"=== WA Sender v8 | {len(contacts)} Colombia+Peru v22 | {TODAY} ===\n", flush=True)

    sent_count = 0
    for i, p in enumerate(contacts, 1):
        country = p.get("country", "Colombia")
        msg = COUNTRY_MSG.get(country, MSG_ES)
