"""
IG DM v43 — v42 pending (after warmup_v42) + v43 warmup-done batch
...
TARGET_USERNAMES = [
    # v42 warmup batch (safety net — skip if already messaged)
    "ultimateoutdoorentertainment",
    "mercurysl",
    "chaudiovisual",
    "nova_productions_llc",
    "priproductions",
    # v43 batch (run after ig_warmup_v43.py)
...
MESSAGES = {
    ...
    "trianglemediasolutions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV integrators in North Carolina. "
        "Your LED video wall sales, installation, and rental services for churches and businesses in the Raleigh-Durham area look great. "
        "We supply P1.5–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing LED panels for installations or events, happy to connect."
    ),
    "theproductionsource": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Tennessee. "
        "Your LED wall rental and AV production services in Knoxville look impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to share specs and pricing."
    ),
    "poweron4u": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in New Orleans. "
        "Your LED video wall rentals for conferences, trade shows, and concerts in NOLA look great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing LED panels for upcoming events, happy to connect."
    ),
    "hinckleyproductions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for production companies in Wisconsin. "
        "Your premium LED wall rentals and virtual production studio in Madison look impressive. "
        "We supply P1.5–P3.9 fine-pitch indoor LED panels at factory-direct pricing. "
        "If you're sourcing LED panels for upcoming productions, happy to share specs."
    ),
    "starstudioswi": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event rental companies in Wisconsin. "
        "Your outdoor-rated modular LED video wall rentals across Southern Wisconsin look great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
...
def main():
    ...
    print(f"=== IG DM v43 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
