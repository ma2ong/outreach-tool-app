"""
IG DM v33 - LatAm batch (Colombia x3 + Peru x1 + Argentina x1)
proyectoresypantallasmede, altema_alquiler_pantallas, publicidad_del_aguila,
mcsydesign, visualledoficial — all warmed up in ig_warmup_v32.py
"""
...
TARGET_USERNAMES = [
    "proyectoresypantallasmede",
    "altema_alquiler_pantallas",
    "publicidad_del_aguila",
    "mcsydesign",
    "visualledoficial",
]
...
MESSAGES = {
    "proyectoresypantallasmede": (
        "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricantes de pantallas LED en Shenzhen, China. "
        "Vimos su tienda y proyectos de pantallas LED en Medellín, Cali y Bogotá — muy buen trabajo. "
        "Suministramos paneles LED P1.8–P5 indoor y outdoor a empresas distribuidoras y de instalación en Colombia. "
        "Si están buscando proveedores directos de fábrica, con gusto les compartimos especificaciones y precios."
    ),
    "altema_alquiler_pantallas": (
        "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricantes de pantallas LED en Shenzhen, China. "
        "Su servicio de alquiler de pantallas LED en Bogotá nos llamó la atención. "
        "Suministramos paneles LED P2–P5 indoor y outdoor a empresas de alquiler en Colombia. "
        "Si están buscando ampliar su inventario o conseguir mejores precios, felices de compartirles info."
    ),
    "publicidad_del_aguila": (
        "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricantes de pantallas LED en China. "
        "Su trabajo en publicidad exterior con pantallas LED en Perú es impresionante. "
        "Fabricamos pantallas LED outdoor P3.9–P10 de alta luminosidad para publicidad y eventos. "
        "Si necesitan cotización o ampliar inventario, con gusto les ayudamos."
    ),
    "mcsydesign": (
        "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricantes de pantallas LED en China. "
        "Su servicio de alquiler de pantallas LED de alta resolución en Rosario es muy profesional. "
        "Fabricamos paneles LED modulares P1.8–P3.9 ideales para eventos y producciones. "
        "Si buscan ampliar su stock o mejorar precios de compra, felices de conversar."
    ),
    "visualledoficial": (
        "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricantes de pantallas LED en Shenzhen, China. "
        "Su trabajo en tecnología de punta en pantallas LED para Colombia es destacado. "
        "Fabricamos y exportamos paneles LED P1.8–P10 para venta, instalación y alquiler. "
        "Si tienen proyectos en curso o quieren cotización directa de fábrica, con gusto les compartimos info."
    ),
}

DEFAULT_MSG = (
    "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricantes de pantallas LED en China. "
    "Suministramos paneles LED P2–P5 indoor y outdoor a empresas de alquiler e instalación. "
    "Si buscan proveedores directos de fábrica con buenos precios, felices de ayudarles."
)
...
def main():
    ...
    print(f"=== IG DM v33 | {len(queue)} LatAm accounts | {TODAY} ===\n", flush=True)
    ...
    for i, username in enumerate(queue, 1):
        ...
        print(f"[{i}/{len(queue)}] @{username} | {p.get('company_en', '')} | {p.get('country', '')}", flush=True)
