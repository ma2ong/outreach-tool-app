"""
WA sender v10 - Colombia v24 + Mexico v24 + Mexico M&S Media (nos 145, 542-546)
Spanish message for all
"""
...
MSG_CO = (
    ...
    "Trabajamos con integradores y empresas de instalacion en Colombia. "
...
MSG_MX = (
    "Hola, soy Allen de Shenzhen Maxcolor Visual, fabricante de pantallas LED en China. "
    "Trabajamos con empresas de renta e instalacion en Mexico. "
    "¿Tienen proyectos activos o planificados? "
    "Podemos dar soporte tecnico y cotizaciones competitivas."
)

TARGET_NOS = [145, 542, 543, 544, 545, 546]
...
def main():
    ...
    print(f"=== WA Sender v10 | {len(contacts)} Colombia+Mexico v24 | {TODAY} ===\n", flush=True)

    sent_count = 0
    for i, p in enumerate(contacts, 1):
        country = p.get("country", "Mexico")
        msg = COUNTRY_MSG.get(country, MSG_MX)
