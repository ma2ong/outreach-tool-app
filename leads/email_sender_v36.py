"""
Email Sender v36 — USA v36 batch (nos 619-625, 7 entries)
...
TARGETS = [
    {"no": 619, "to": "info@elitedisplays.com",            "name": ""},
    {"no": 620, "to": "connect@vitaeventsgroup.com",        "name": ""},
    {"no": 621, "to": "info@verumav.com",                   "name": ""},
    {"no": 622, "to": "info@powerfactorypro.com",           "name": ""},
    {"no": 623, "to": "Jake@arizonastage.com",              "name": "Jake"},
    {"no": 624, "to": "hello@palmproductionsandevents.com", "name": ""},
    {"no": 625, "to": "info@empireentertainment.us",        "name": ""},
]
...
def main():
    print(f"=== Email Sender v36 | {len(TARGETS)} USA v36 | {TODAY} ===\n", flush=True)
    sent = 0
