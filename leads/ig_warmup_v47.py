"""IG Warmup v47 — like + follow 4 accounts before DM
Accounts: gsf_productions / productiononeav / techproavtx / voxaudiovisual
"""
...
def main():
    ...
    print(f"=== IG Warmup v47 | {len(TARGET_USERNAMES)} accounts | {TODAY} ===\n", flush=True)
