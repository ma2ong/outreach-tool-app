...
MESSAGES = {
    "zascoproduction": (
        ...
        "Saw your LED video wall work across New England and love what you do. "
...
def main():
    ...
    print(f"=== IG DM v51 | {len(queue)} accounts | {TODAY} ===\n", flush=True)
