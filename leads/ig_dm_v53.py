"""
IG DM v53 — v52 batch IG account (no warmup, direct send)
@alfacom.cl (Alfacom Chile, Santiago CL, no:736) — Spanish
"""
...
TARGETS = [
    {"no": 736, "username": "alfacom.cl", "company_en": "Alfacom Chile", "city": "Santiago, CL"},
]

MESSAGES = {
    "alfacom.cl": (
        "Hola! Soy de Shenzhen, China — fabricamos paneles LED para empresas de arriendo e instalacion. "
        "Vi su trabajo con pantallas LED en Santiago — muy buena propuesta. "
        ...
        "Si necesitan cotizacion o tienen algun proyecto, con gusto los atendemos!"
    ),
}
...
def main():
    print(f"=== IG DM v53 | {len(TARGETS)} accounts | {TODAY} ===\n", flush=True)
