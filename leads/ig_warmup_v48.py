"""IG Warmup v48 — like + follow 4 accounts before DM
Accounts: rockymountainroll / sealsproductions / ampdlightingaudiovisual / avl_solutions
"""
...
def main():
    ...
    print(f"=== IG Warmup v48 | {len(TARGET_USERNAMES)} accounts | {TODAY} ===\n", flush=True)
