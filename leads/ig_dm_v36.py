"""
IG DM v36 - USA v34 batch (14 accounts, all warmed up in ig_warmup_v36.py)
"""
...
TARGET_USERNAMES = [
    ...
    "eventsmathes",
    "picturethisportland",
    "northstateaudiovisual",
]

MESSAGES = {
    "av.for.you": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV rental companies in Minneapolis. "
        "Your outdoor mobile LED video wall trailer service for events is impressive. "
    ...
    "fireupcreative": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Minneapolis. "
        "Your modular LED video wall and outdoor mobile LED trailer for Midwest events looks great. "
        "We supply P2–P5 LED panels at factory-direct pricing for rental operations. "
        "If you're sourcing panels, happy to share specs and pricing."
    ),
    "showtime.led": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for rental companies in Kansas City. "
        "Your mobile LED screen and video wall rental for watch parties and outdoor events is impressive. "
        "We supply P3.9–P5 outdoor LED panels at competitive factory pricing. "
        "If you're looking to expand your LED inventory, happy to connect."
    ),
    "kceventcompany": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in Kansas City. "
        "Your LED video wall rental and full-service event production looks great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels or expanding inventory, happy to share specs."
    ),
    "tsvusa": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in St. Louis. "
        "Your modular LED display rental and sales for indoor and outdoor events is impressive. "
        "We supply P2–P5 LED panels at factory-direct pricing. "
        "If you're looking to source panels, happy to connect."
    ),
    "jawsaudio": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED video wall panels for AV companies in San Antonio. "
        "Your LED video wall rental and installation serving Texas looks great. "
        "We supply P2–P5 indoor and outdoor LED panels at competitive factory pricing. "
        "If you're sourcing panels, happy to share specs and pricing."
    ),
    "dpcevents": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in San Antonio. "
        "Your LED video wall rental and corporate event production is impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to connect."
    ),
    "outdoorledrentals": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for rental companies in Nashville. "
        "Your outdoor HD LED screen rental with onsite technician service is impressive. "
        "We supply P3.9–P5 high-brightness outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels or expanding inventory, happy to share specs."
    ),
    "elitemultimedia": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in Nashville. "
        "Your creative LED wall rental for trade shows and conferences is impressive. "
        "We supply P2–P3.9 fine-pitch LED panels at competitive factory pricing. "
        "If you're sourcing panels, happy to connect."
    ),
    "fairfieldproav": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Charlotte. "
        "Your LED video wall rental and event AV production looks great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to share specs."
    ),
    "fireflyclt": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Charlotte. "
        "Your LED wall rental and event production services look great. "
        "We supply P2–P3.9 fine-pitch LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to connect."
    ),
    "eventsmathes": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in Atlanta. "
        "Your LED display rental serving Charlotte, Nashville, and the Southeast is impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to share specs and pricing."
    ),
    "picturethisportland": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Portland. "
        "Your LED video wall rental and AV production services are impressive — great to see LED wall in Oregon. "
        "We supply P2–P3.9 LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to connect."
    ),
    "northstateaudiovisual": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Northern California. "
        "Your LED video wall rental serving Sacramento and the Bay Area is impressive. "
        "We supply P2–P3.9 fine-pitch LED panels at competitive factory pricing. "
        "If you're looking to expand your LED inventory, happy to share specs."
    ),
}
...
(function() {
  ...
  var btn = btns.find(b => { var t = b.innerText.trim(); return t === "发消息" || t === "Message"; });
...
def main():
    ...
    print(f"=== IG DM v36 | {len(queue)} USA v34 accounts | {TODAY} ===\n", flush=True)
