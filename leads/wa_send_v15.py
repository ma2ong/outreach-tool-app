"""
WA sender v15 - Colombia Visual LED Oficial (no:495)
Phone found from website: +57 310 873 1503
"""
...
MSG = (
    ...
    "Vi su trabajo en pantallas LED para Colombia — muy buen trabajo. "
    "Trabajamos con empresas de venta e instalacion en Colombia. "
    "Si tienen proyectos o necesitan cotizacion de paneles LED, con gusto les ayudamos."
)
...
def main():
    ...
    print(f"=== WA Sender v15 | {len(contacts)} Colombia | {TODAY} ===\n", flush=True)
