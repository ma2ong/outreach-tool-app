"""
Email sender v53 — v53 batch (6 companies with email)
Mexico: Servittec Audiovisual (CDMX), PROLED (Guadalajara),
        Luas Sound Events (Guadalajara), ABK Lighting (CDMX), GDLED (Guadalajara)
...
TARGETS = [
    {"no": 738, "company_en": "Servittec Audiovisual",  "email": "servittec@servittecaudiovisual.com.mx", "name": "Servittec Team",   "city": "Mexico City, MX"},
    {"no": 739, "company_en": "PROLED Guadalajara",     "email": "Jorgeibarrah@proled.com.mx",            "name": "Jorge",            "city": "Guadalajara, MX"},
    {"no": 740, "company_en": "Luas Sound Events",      "email": "info@luaseventos.com.mx",               "name": "Luas Sound Team",  "city": "Guadalajara, MX"},
    {"no": 741, "company_en": "ABK Lighting Mexico",    "email": "info@abk.mx",                           "name": "ABK Team",         "city": "Mexico City, MX"},
    {"no": 744, "company_en": "GDLED Guadalajara",      "email": "contacto@gdled.com.mx",                 "name": "GDLED Team",       "city": "Guadalajara, MX"},
    {"no": 745, "company_en": "StageCore Chile",        "email": "contacto@stagecore.cl",                 "name": "StageCore Team",   "city": "Santiago, CL"},
]
...
def main():
    ...
    print(f"=== Email Sender v53 | {len(TARGETS)} targets | {TODAY} ===", flush=True)
