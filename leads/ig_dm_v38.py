"""
IG DM v38 - USA v36 batch (6 accounts, warmed up in ig_warmup_v38.py)
Elite Displays, Verum AV Solutions, Power Factory Productions,
...
MESSAGES = {
    "elitedisplays": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for integrators and rental companies in Las Vegas. "
        "Your portfolio of LED installations for sports venues, casinos, and hospitality projects is impressive. "
        "We supply P1.2–P5 indoor and outdoor LED panels at factory-direct pricing for integrators and large-scale projects. "
        "Happy to share product specs and pricing if you have upcoming LED projects."
    ),
    "verumavsolutions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Houston. "
        "Your LED screen and AV rental services for events look great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to connect and share specs."
    ),
    "powerfactoryproductions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Houston. "
        "Your LED video wall and AV production services look impressive. "
    ...
    "arizonastage": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Arizona. "
        "Your LED video wall rental and stage production services across Arizona look impressive. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to connect."
    ),
    "palmproductionsandevents": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in Tampa. "
        "Your LED video wall and full-service event production in South Florida looks great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to share specs and pricing."
    ),
    "empire_djs": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Orlando. "
        "Your LED video wall rental and AV services for Central Florida events look great. "
        "We supply P2–P3.9 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to connect."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v38 | {len(queue)} USA v36 accounts | {TODAY} ===\n", flush=True)
