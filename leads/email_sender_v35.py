"""
Email Sender v35 — USA v35 batch (nos 611-618, 8 entries)
...
TARGETS = [
    {"no": 611, "to": "chuck@paentertainmentgroup.com",         "name": "Chuck"},
    {"no": 612, "to": "events@miteyav.com",                     "name": ""},
    {"no": 613, "to": "josh@refreshled.com",                    "name": "Josh"},
    {"no": 614, "to": "customerservice@worshipproductions.org",  "name": ""},
    {"no": 615, "to": "info@cprmms.com",                        "name": ""},
    {"no": 616, "to": "t.bender@mediaquest.biz",                "name": ""},
    {"no": 617, "to": "info@vortexledwall.com",                 "name": ""},
    {"no": 618, "to": "Events@TheOneUpGroup.com",               "name": ""},
]
...
def main():
    print(f"=== Email Sender v35 | {len(TARGETS)} USA v35 | {TODAY} ===\n", flush=True)
    sent = 0
