"""
IG DM v37 - USA v35 batch (8 accounts, warmed up in ig_warmup_v37.py)
...
MESSAGES = {
    "paentertainmentgroup": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for event companies in Harrisburg. "
        "Your LED video wall rental and event production services for corporate and live events look impressive. "
    ...
    "miteyav": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in New Orleans. "
        "Your LED video wall and AV rental services for Gulf Coast events look great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're sourcing panels or expanding inventory, happy to connect."
    ),
    "getrefreshled": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for rental companies in Pennsylvania. "
        "Your LED video wall rental services look great. "
    ...
    "worshipproductions": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for production companies in Southern California. "
        "Your LED video wall services for churches and live events look impressive. "
    ...
    "cprmms": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in the Maryland/DC area. "
        "Your LED video wall rental for corporate events and conferences looks great. "
        "We supply P2–P3.9 indoor LED panels at factory-direct pricing. "
        "If you're sourcing panels, happy to share specs and pricing."
    ),
    "mediaquestpgh": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Pittsburgh. "
        "Your LED video wall and AV production rental for corporate and live events looks great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to connect."
    ),
    "vortexledwall": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for rental companies in San Diego. "
        "Your specialist LED video wall rental for events, trade shows, and concerts is impressive. "
        "We supply P2–P3.9 fine-pitch LED panels at competitive factory pricing. "
        "If you're sourcing panels, happy to share specs and pricing."
    ),
    "theoneupgroup": (
        "Hi, I'm Allen from Shenzhen Maxcolor Visual — we manufacture LED display panels for AV companies in Los Angeles. "
        "Your LED video wall and full-service AV production for music and entertainment events looks great. "
        "We supply P2–P5 indoor and outdoor LED panels at factory-direct pricing. "
        "If you're looking to expand your LED inventory, happy to connect."
    ),
}
...
def main():
    ...
    print(f"=== IG DM v37 | {len(queue)} USA v35 accounts | {TODAY} ===\n", flush=True)
